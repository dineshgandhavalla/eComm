...
<body>
    <div class="login-card"><img class="img-circle profile-img-card" src="assets/img/rv_1-gito-1.jpg">
        <p class="profile-name-card"> </p>
        <form class="form-signin" action="j_spring_security_check" method="post"><span class="reauth-email"> </span>
